...
<body>
    ...
    <div class="container my-3">
        ...
        <form>
            <div class="form-group">
                ...
                <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="ime@example.com">
            </div>
            <div class="form-group">
                <label for="exampleFormControlTextarea1">Napišite svoj problem/Dajte nam povratnu informaciju</label>
    ...
    <!-- Footer treba biti izvan containera -->
